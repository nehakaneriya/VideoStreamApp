      ...
      <div className="bg-[#121214] p-5 sm:p-6 rounded-3xl shadow-2xl w-full max-w-md border border-white/10 animate-fade-in-up">
        ...
        <form className="space-y-3" onSubmit={handleRegister}>
          ...
          <div>
            ...
            {showRequirements && (
              <div className="mt-1.5 rounded-lg border border-gray-700/60 bg-[#0f0f0f]/60 p-2.5 animate-fade-in-up">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-red-600 cursor-pointer hover:bg-red-700 py-3 rounded-xl text-base font-bold transition-all shadow-lg shadow-red-600/30 active:scale-[0.98] disabled:opacity-70 flex items-center justify-center gap-2 group"
          >
            {loading ? <Spinner /> : (
              <>
